...
namespace EtlLib.Nodes.Redshift.Builders.Copy
{
    ...
    public interface IRedshiftCopyCommandBuilder
    {
        ...
        IRedshiftCopyCommandBuilder NullAs(string nullString);
    }
    ...
    public class RedshiftCopyCommandBuilder : IRedshiftBuilder, IRedshiftCopyCommandBuilder, IRedshiftCopyFromAuthorizedByBuilder, IRedshiftCopyFromBuilder
    {
        ...
        public IRedshiftCopyCommandBuilder NullAs(string nullString)
        {
            _nullAs = nullString;
            return this;
        }
        ...
        public string Build()
        {
            ...
            sb.AppendLine(BuildNullAsStatement());
        ...
        private string BuildNullAsStatement()
        {
            var statement = new StringBuilder();
            if (_nullAs != null)
